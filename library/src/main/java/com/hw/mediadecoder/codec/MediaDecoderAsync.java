 ...
 */
@Deprecated
public class MediaDecoderAsync extends MediaCodec.Callback implements IMediaDecoder {
    /**
     * 未读取到帧率时的默认值
     */
    ...
    public MediaDecoderAsync(MediaExtractor mediaExtractor, MediaData mediaData, RunnableThread seekThread, long seekAccuracyMs) {
    ...
    public void prepare() throws IOException {
        ...
        mCodecColorFormat = mMediaCodec.getOutputFormat().getInteger(MediaFormat.KEY_COLOR_FORMAT);
        mMode = Mode.SEEK;
    }
    ...
    public void onOutputFormatChanged(MediaCodec codec, MediaFormat format) {
        mCodecColorFormat = format.getInteger(MediaFormat.KEY_COLOR_FORMAT);
    }
