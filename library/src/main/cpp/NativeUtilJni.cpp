...
planesToYUV1(JNIEnv *env, jclass type, jobject buffer1, jobject buffer2,
...
static JNINativeMethod methods[] = {
        {"planesToYUV1", "(Ljava/nio/ByteBuffer;Ljava/nio/ByteBuffer;Ljava/nio/ByteBuffer;IIIIIIIIIIILjava/nio/ByteBuffer;Ljava/nio/ByteBuffer;Ljava/nio/ByteBuffer;)V", reinterpret_cast<void *>(planesToYUV1)}
};
