...
public class GLFrameRendererYUV  {//implements Renderer

//    private ISimplePlayer mParentAct;
//    private GLSurfaceView mTargetSurface;
//    private GLProgram420sp prog;
...
//
//    public GLFrameRendererYUV(ISimplePlayer callback, GLSurfaceView surface, DisplayMetrics dm, MediaFramePool pool) {
//        mParentAct = callback;
//        mTargetSurface = surface;
//        mScreenWidth = dm.widthPixels;
//        mScreenHeight = dm.heightPixels;
//        playDemo = new PlayDemo(this,pool);
//        prog = new GLProgram420sp(surface.getContext().getApplicationContext(),0);
//    }
//
//    @Override
...
//                float f2 = 1f * h / w;
//                if (f1 == f2) {
//                    prog.createBuffers(GLProgram420sp.squareVertices);
//                } else if (f1 < f2) {
